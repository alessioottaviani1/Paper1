...
reader. It is therefore relegated to an appendix with the mis-specification
note; the headline robustness is the cross-method bake-off (05) + this
bootstrap inference + the OOS test (06).
