...
def run_scheme(mode):
    ...
    print(f"\n  ── {mode.upper()} ──  ({win_note} | NO LASSO | hedge = stable set, "
...
def main():
    bar = "=" * 92
    print(bar)
    print("AEN OUT-OF-SAMPLE ALPHA  (alpha_0, frozen stable set, past-only beta)")
    print(bar)
    ...
    print("    the past window, slopes-only residual, NW(1994) HAC. NO LASSO, NO PCA —")
    print("    the stable set is frozen.")
    print("  - This is alpha_0 (the level). The conditional stress slope alpha_1 is handled")
    print("    separately (post-selection inference: PDS / re-selection bootstrap).")
