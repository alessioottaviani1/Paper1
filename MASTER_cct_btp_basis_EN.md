...
**Status:** pipeline complete on the full 1995–2026 sample; all indexation engines validated against Bloomberg coupons and official auction data; five candidate mechanisms tested under a uniform identification criterion — two survive, three rejected.
...
*The Nagel test carries a declared identification warning: within-year variance of the short rate is 4.5% of the total, so the year-FE specification is nearly uninformative — a different statement from "the mechanism does not exist". The supply-scarcity coefficient turns to the predicted negative sign under fixed effects (−0.014, t −2.8) but with similarly limited within-year identification (9.4%).
