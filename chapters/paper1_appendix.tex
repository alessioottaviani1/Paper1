...
Table~\ref{tab:pca_cond_fs_contemporaneous_article} reports
\citet{christopherson1998conditioning} conditional alpha using PCA factors.
...
\citet{christopherson1998conditioning} conditional alpha model with AEN-selected factors.
