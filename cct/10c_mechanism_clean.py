...
if __name__ == "__main__":
    ...
    # NOTA ONLY_CCTEU: 10c NON si filtra ai soli CCTeu, perche' il suo test decisivo E'
    # il confronto fra regimi (il CDS sovrano muove la base nei CCT-BOT dove NON puo' essere
    # meccanico). Con i soli CCTeu l'effetto sovrano resta ambiguo (due curve). 10c resta
    # quindi diagnostica di COSTRUZIONE su entrambi i regimi; il risultato economico sul
    # canale sovrano vale per i CCT-BOT e va riportato come tale, in attesa della guida RR.
    print("  [10c gira su ENTRAMBI i regimi: e' il test di costruzione, non filtrabile ai CCTeu]")
