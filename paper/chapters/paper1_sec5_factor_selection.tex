...
BTP~Italia, the industrial bond return for the CDS--Bond basis, and
fixed-income momentum and the variance-swap return for the iTraxx
skew---and the post-double-selection control set is a subset of these,
empty for the iTraxx skew, where no candidate clears its threshold
(Appendix~\ref{app:aen_selection_matrix}). The out-of-sample alpha of
