...
2004 to 2009 period, with peaks exceeding $200$ basis points during
...
\item We subject the alpha estimates to a progressive battery of
  ...
  fixed-income hedge fund literature \citep{duarte2007risk,
  ...
  factor combination; the selected models are re-run under five
  ...
  split-sample inference, and the alpha verdict is invariant to the
  choice. Using the conditional framework of
