...
strategy by the best-subset primary selector and by the adaptive elastic
net. The overlap across selectors is partial, as expected when highly
correlated candidates substitute for one another, but the economically
central exposures recur in every method, so the identified risks are not
an artifact of the cardinality constraint or of any single penalization
scheme.
