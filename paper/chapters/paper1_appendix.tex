...
Table~\ref{tab:aen_selection_names} lists the factors that each method
of Table~\ref{tab:selector_robustness} selects, strategy by strategy.
It is the evidence behind the claim of Section~\ref{sec:aen} that the
identity of the selected set varies across selectors while the alpha
does not.
