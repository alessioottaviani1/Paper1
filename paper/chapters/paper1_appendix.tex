...
This appendix reports sub-period splits and threshold robustness for
the benchmark factor models of Section~\ref{sec:benchmarks}. Each table contains
...
\caption[Rolling 36-Month Alpha with Regime Shading --- Duarte et al.\ (2007)]{Rolling 36-Month Alpha with Regime Shading --- Duarte et al.\ (2007).
  95\% confidence bands. Shading denotes the iTraxx Main 5Y regime:
  green (LOW, $<$60 bps), amber (MEDIUM, 60--100 bps), red (HIGH,
  $\geq$100 bps).}
...
\caption[Rolling 36-Month Alpha with Regime Shading --- Brooks et al.\ (2020)]{Rolling 36-Month Alpha with Regime Shading --- Brooks et al.\ (2020).
...
\caption[Rolling 36-Month Alpha with Regime Shading --- Fung \& Hsieh (2004)]{Rolling 36-Month Alpha with Regime Shading --- Fung \& Hsieh (2004).
  Same format as Figure~\ref{fig:app_rolling_duarte}.}
