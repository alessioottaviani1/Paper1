...
three frameworks. The point estimates are of the same order as the
in-sample alphas of Panel~A, with no systematic attenuation---the
in-sample loadings were not fitted to the alpha they hedge---and the
ranking across strategies is preserved, with the CDS--Bond basis the
