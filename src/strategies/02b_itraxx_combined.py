"""
Script 2c: Simulazione Trading Strategy iTraxx Skew — Signal-Weighted
==========================================================================
...
import warnings
import sys
sys.path.insert(0, str(Path(__file__).parent.parent / "factor_models"))
import factor_sources as fs  # type: ignore
...
# iTraxx Main 5Y spread now sourced from data/raw/bloomberg/bbg.xlsx via factor_sources
ITRX_MAIN5_TICKER = "ITRX EUR CDSI GEN 5Y Corp"
...
_cds = fs.load_cds_fields(sheet="cds")
itrx_main_daily = pd.to_numeric(
    _cds["spread"][ITRX_MAIN5_TICKER], errors="coerce"
).dropna()
