...
plt.tight_layout()
plt.savefig(RESULTS_DIR / '04_top_isins.pdf', bbox_inches='tight')
print(f"💾 Salvato: 04_top_isins.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig(RESULTS_DIR / '05_exit_reasons.pdf', bbox_inches='tight')
print(f"💾 Salvato: 05_exit_reasons.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig(RESULTS_DIR / '06_rolling_stats.pdf', bbox_inches='tight')
print(f"💾 Salvato: 06_rolling_stats.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig(RESULTS_DIR / '07_drawdown.pdf', bbox_inches='tight')
print(f"💾 Salvato: 07_drawdown.pdf")
plt.close()
...
plt.tight_layout()
plt.savefig(RESULTS_DIR / '08_pnl_components.pdf', bbox_inches='tight')
print(f"💾 Salvato: 08_pnl_components.pdf")
plt.close()
...
print("   4. 04_top_isins.pdf          - Top ISIN per performance")
print("   5. 05_exit_reasons.pdf       - Distribuzione motivi chiusura")
print("   6. 06_rolling_stats.pdf      - Statistiche rolling 1-anno")
print("   7. 07_drawdown.pdf           - Drawdown analysis")
print("   8. 08_pnl_components.pdf     - Carry vs Capital Gain")
print("\n   📄 CSV:")
