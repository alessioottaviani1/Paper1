...
print("=" * 80)
print("STEP 1: Caricamento risultati - iTraxx Skew Portfolio")
print("=" * 80)
...
ax1.set_title('iTraxx Skew Portfolio - Equity Curve', fontsize=16, fontweight='bold')
...
print("\n" + "=" * 80)
print("STRATEGY SUMMARY STATISTICS - iTraxx Skew Portfolio")
print("=" * 80)
