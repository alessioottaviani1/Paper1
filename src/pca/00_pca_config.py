...
Riferimento (spanning contemporaneo via PCA su rendimenti): Connor & Korajczyk
(1986, 1988, JFE); Giglio & Xiu (2021, JPE). Bai & Ng (2002) per il numero di fattori.
...
#
# Numero di componenti: ancorato ai criteri d'informazione di Bai & Ng (2002)
# e al profilo di varianza cumulata; robustezza su K in appendice.
