...
def main():
    ...
    L = [r"\begin{table}[H]",
         r"\centering",
         r"\singlespacing",
         r"\caption{Out-of-Sample Alpha: PCA and AEN}",
         r"\label{tab:pca_oos}",
         r"\begin{minipage}{\textwidth}",
         r"{\footnotesize\noindent Out-of-sample alpha of the PCA (Panel A) and AEN (Panel B) "
         ...
         r"to the sign and rotation indeterminacy of PCA; in Panel B the stability-selected "
         ...
         r"\midrule"]
    for panel_name, cell_fn in (("Panel A: PCA", _pca_cell), ("Panel B: AEN", _aen_cell)):
