...
def build_pc1_funding():
    ...
    tex = [r"\begin{table}[H]", r"\centering", r"\singlespacing",
           ...
           r"strategies and the evidence rests on signs and significance. Only "
           r"intermediary coefficients survive the Benjamini--Hochberg correction "
           r"for the full set of RQ3 tests (Table~\ref{tab:rq3_mtc}); no macro "
           r"coefficient does. Newey--West HAC standard errors (4 lags). "
           r"$^{***}\,p<0.01$, $^{**}\,p<0.05$, $^{*}\,p<0.10$.}",
