...
def build_unified_correlations():
    ...
    tex.append(r"{\footnotesize\noindent "
               ...
               r"$\Delta m_{i,t}$ its monthly change. The table reports correlations of the "
               r"monthly $\Delta m$ series. "
               ...
               r"\citet{forbes2002no} adjustment for the higher variance in the HIGH regime, "
