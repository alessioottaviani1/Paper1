...
def main():
    ...
    # Check for factors not in FACTOR_INFO (applica prima l'alias di display, così
    # i nomi Fung-Hsieh PTFSBD/PTFSCOM/PTFSFX sono riconosciuti via BdOpt/ComOpt/FXOpt)
    DISPLAY_ALIAS = {"PTFSBD": "BdOpt", "PTFSFX": "FXOpt", "PTFSCOM": "ComOpt"}
