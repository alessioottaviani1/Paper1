...
def _build_fs_thesis(all_results):
    ...
    tex.append(r"{\footnotesize\noindent "
               ...
               r"$r_t = \alpha_0 + \alpha_1 z_t + (\boldsymbol{\beta} + \boldsymbol{\delta} z_t)'"
               r"\mathbf{f}_{\hat S,t} + \varepsilon_t$, with the AEN-selected factors: both the "
               r"alpha and the factor loadings are conditioned on $z_t$, the standardized iTraxx "
               r"Main 5Y spread (mean zero, unit variance); $\alpha_1>0$ indicates alpha rises "
