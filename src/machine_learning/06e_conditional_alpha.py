...
def _build_fs_thesis(all_results):
    ...
    tex.append(r"\item \textit{Note:} "
               ...
               rf"$t$-statistics in parentheses, and the HAC $p$-value (rule-of-thumb lag {HAC_LAGS}) "
               r"is reported as a robustness check and yields identical conclusions. "
