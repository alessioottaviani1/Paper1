...
def run(mkt: str, span=None):
    ...
    if mkt == "US":
        # gamma_hat = BEI - pi_hat(Cleveland), tesi eq. (7) RIGA 1: fa parte della
        # specificazione di Maffei, quindi gira su OGNI campione (non solo il suo).
        # NESSUN fallback: richiede an_expinf_US (modello Cleveland).
