...
MATS = {"UK": (2.5, 5.0, 10.0, 15.0, 20.0), "US": (2.0, 5.0, 10.0, 15.0, 20.0),
        "IT": (2.0, 5.0, 10.0, 15.0, 20.0),
        "FR": (2.0, 5.0, 10.0, 15.0, 20.0), "DE": (2.0, 5.0, 10.0, 15.0, 20.0)}
REAL = {"UK": lambda: rp.boe("real"), "US": lambda: rp.gsw("tips", MATS["US"]),
        "IT": lambda: rp.nss_panel("real_IT", MATS["IT"]),
        "FR": lambda: rp.nss_panel("real_FR", MATS["FR"]),
        "DE": lambda: rp.nss_panel("real_DE", MATS["DE"])}
