...
# Euro (IT/FR/DE): curve reali NOSTRE (nss_real_*, analitiche) valutate su griglia densa
# che copre target, target-1 e i forward; CPI = HICPxT (CPTFEMU) per tutti e tre.
# NOTA DE: campione dal 2012 (~150 oss. overlapping) e long-end nei primi anni oltre
# l'ultimo Bund€i -> estrapolazione del modello: risultati DE da leggere con cautela.
_EURO_GRID = (2., 3., 4., 5., 6., 7., 8., 9., 10., 12., 14., 15., 19., 20.)
CONF = {"UK": dict(y=lambda: rp.boe("real"), mats=(5., 7., 10., 15., 20.), cpi="UK"),
        ...
        "IT": dict(y=lambda: rp.nss_panel("real_IT", _EURO_GRID),
                   mats=(5., 7., 10., 15., 20.), cpi="IT"),
        "FR": dict(y=lambda: rp.nss_panel("real_FR", _EURO_GRID),
                   mats=(5., 7., 10., 15., 20.), cpi="FR"),
        "DE": dict(y=lambda: rp.nss_panel("real_DE", _EURO_GRID),
                   mats=(5., 7., 10., 15., 20.), cpi="DE")}
