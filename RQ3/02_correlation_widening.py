...
_stress_raw = pd.read_csv(RQ3_DATA_DIR / "stress_proxy_monthly.csv",
                          index_col=0, parse_dates=True)[DEFAULT_STRESS_PROXY] \
    .reindex(df_dm_full.index, method='ffill')
# Standardizza (coerente con LaTeX e con rq3_03; riduce la collinearità
# tra 'stress' e 'x_widen × stress' che gonfia lo SE del termine di interazione)
stress_level = (_stress_raw - _stress_raw.mean()) / _stress_raw.std()
