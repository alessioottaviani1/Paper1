...
sys.path.insert(0, str(PROJECT_ROOT / "factor_models"))
from factor_sources import load_hkm, load_bloomberg  # type: ignore
...
factors_monthly["HKM"] = _hkm["intermediary_capital_risk_factor"].reindex(factors_monthly.index)
...
funding_sets = {
    "Core":     PC1_FUNDING_FACTORS,                                                    # con LIBOR_OIS
    "Core_EUR": ["EURIBOR_OIS" if f == "LIBOR_OIS" else f for f in PC1_FUNDING_FACTORS],  # con EURIBOR_OIS (confronto temporaneo)
